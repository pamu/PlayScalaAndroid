...
object Global extends GlobalSettings {
  ...
  override def onStart(app: Application): Unit = {
    ...
    carStore ! AddCar(name = "swif", url = "http://i.ndtvimg.com/auto/makers/29/205/suzuki-swift-2011-front-view.jpg")
    carStore ! AddCar(name = "martui", url = "http://i.ndtvimg.com/auto/makers/29/196/2012-maruti-suzuki-ertiga-001-1570.jpg")
